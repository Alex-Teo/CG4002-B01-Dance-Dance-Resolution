set moduleName mlp_dance3_Pipeline_loadweights0_VITIS_LOOP_46_2
set isTopModule 0
...
set C_modelName {mlp_dance3_Pipeline_loadweights0_VITIS_LOOP_46_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ weights_0 float 32 regular {array 624 { 0 3 } 0 1 }  }
	{ S_AXIS_V int 64 regular {axi_s 0 volatile  { S_AXIS_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weights_0", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ S_AXIS_V_TVALID sc_in sc_logic 1 invld 1 } 
	{ weights_0_address0 sc_out sc_lv 10 signal 0 } 
	{ weights_0_ce0 sc_out sc_logic 1 signal 0 } 
	{ weights_0_we0 sc_out sc_logic 1 signal 0 } 
	{ weights_0_d0 sc_out sc_lv 32 signal 0 } 
	{ S_AXIS_V_TDATA sc_in sc_lv 64 signal 1 } 
	{ S_AXIS_V_TREADY sc_out sc_logic 1 inacc 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_4ns_7ns_7ns_10_4_1_U107", "Parent" : "0"},
...
set Spec2ImplPortList { 
	weights_0 { ap_memory {  { weights_0_address0 mem_address 1 10 }  { weights_0_ce0 mem_ce 1 1 }  { weights_0_we0 mem_we 1 1 }  { weights_0_d0 mem_din 1 32 } } }
