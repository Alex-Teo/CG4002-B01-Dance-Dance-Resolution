...
module mlp_dance3_mlp_dance3_Pipeline_layer3_pos (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [31:0] weights_3_pos_q0;
output  [6:0] weights_3_pos_address1;
output   weights_3_pos_ce1;
input  [31:0] weights_3_pos_q1;
...
reg   [1:0] i_15_reg_152;
reg   [1:0] i_15_reg_152_pp0_iter1_reg;
reg   [1:0] i_15_reg_152_pp0_iter2_reg;
reg   [1:0] i_15_reg_152_pp0_iter3_reg;
reg   [1:0] i_15_reg_152_pp0_iter4_reg;
reg   [1:0] i_15_reg_152_pp0_iter5_reg;
reg   [1:0] i_15_reg_152_pp0_iter6_reg;
reg   [1:0] i_15_reg_152_pp0_iter7_reg;
reg   [1:0] i_15_reg_152_pp0_iter8_reg;
reg   [1:0] i_15_reg_152_pp0_iter9_reg;
reg   [1:0] i_15_reg_152_pp0_iter10_reg;
wire   [0:0] icmp_ln206_fu_100_p2;
reg   [0:0] icmp_ln206_reg_159_pp0_iter1_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter2_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter3_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter4_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter5_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter6_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter7_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter8_reg;
reg   [0:0] icmp_ln206_reg_159_pp0_iter9_reg;
wire   [31:0] grp_calculate_1_fu_79_ap_return;
reg   [31:0] val_reg_163;
...
wire    grp_calculate_1_fu_79_ap_start;
wire    grp_calculate_1_fu_79_ap_done;
wire    grp_calculate_1_fu_79_ap_idle;
wire    grp_calculate_1_fu_79_ap_ready;
wire   [6:0] grp_calculate_1_fu_79_a_address0;
wire    grp_calculate_1_fu_79_a_ce0;
wire   [6:0] grp_calculate_1_fu_79_a_address1;
wire    grp_calculate_1_fu_79_a_ce1;
wire   [6:0] grp_calculate_1_fu_79_b_address0;
wire    grp_calculate_1_fu_79_b_ce0;
wire   [6:0] grp_calculate_1_fu_79_b_address1;
wire    grp_calculate_1_fu_79_b_ce1;
reg    grp_calculate_1_fu_79_ap_start_reg;
...
wire   [63:0] zext_ln206_fu_126_p1;
reg   [1:0] i_fu_44;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_i_15;
wire   [1:0] add_ln206_fu_106_p2;
...
#0 grp_calculate_1_fu_79_ap_start_reg = 1'b0;
#0 ap_done_reg = 1'b0;
end

mlp_dance3_calculate_1 grp_calculate_1_fu_79(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b0 == ap_block_pp0_stage11_subdone) & (ap_loop_exit_ready_pp0_iter9_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_calculate_1_fu_79_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln206_fu_100_p2 == 1'd0))) begin
            grp_calculate_1_fu_79_ap_start_reg <= 1'b1;
        end else if ((grp_calculate_1_fu_79_ap_ready == 1'b1)) begin
            grp_calculate_1_fu_79_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_idle_pp0_0to8 == 1'b1) & (1'b1 == ap_condition_exit_pp0_iter9_stage11))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln206_fu_100_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln206_reg_159 == 1'd1) & (1'b0 == ap_block_pp0_stage15_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage11_subdone) & (ap_enable_reg_pp0_iter9 == 1'b1) & (icmp_ln206_reg_159_pp0_iter9_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage11_subdone) & (ap_loop_exit_ready_pp0_iter9_reg == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11))) begin
        ap_done_int = 1'b1;
    end else begin
...
assign add_ln206_fu_106_p2 = (ap_sig_allocacmp_i_15 + 2'd1);
...
assign buffer_2_address0 = grp_calculate_1_fu_79_a_address0;

assign buffer_2_address1 = grp_calculate_1_fu_79_a_address1;

assign buffer_2_ce0 = grp_calculate_1_fu_79_a_ce0;

assign buffer_2_ce1 = grp_calculate_1_fu_79_a_ce1;

assign buffer_3_address0 = zext_ln206_fu_126_p1;

assign buffer_3_d0 = add_reg_173;

assign grp_calculate_1_fu_79_ap_start = grp_calculate_1_fu_79_ap_start_reg;

assign grp_fu_705_p_ce = 1'b1;

assign grp_fu_705_p_din0 = val_reg_163;

assign grp_fu_705_p_din1 = tmp_s_fu_117_p5;

assign grp_fu_705_p_opcode = 2'd0;

assign icmp_ln206_fu_100_p2 = ((ap_sig_allocacmp_i_15 == 2'd3) ? 1'b1 : 1'b0);

assign weights_3_pos_address0 = grp_calculate_1_fu_79_b_address0;

assign weights_3_pos_address1 = grp_calculate_1_fu_79_b_address1;

assign weights_3_pos_ce0 = grp_calculate_1_fu_79_b_ce0;

assign weights_3_pos_ce1 = grp_calculate_1_fu_79_b_ce1;

assign zext_ln206_fu_126_p1 = i_15_reg_152_pp0_iter10_reg;

endmodule //mlp_dance3_mlp_dance3_Pipeline_layer3_pos
