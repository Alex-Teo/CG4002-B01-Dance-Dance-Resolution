...
module mlp_dance3_mlp_dance3_Pipeline_layer3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [6:0] buffer_2_address1;
output   buffer_2_ce1;
input  [31:0] buffer_2_q1;
output  [13:0] weights_3_address0;
output   weights_3_ce0;
input  [31:0] weights_3_q0;
output  [13:0] weights_3_address1;
output   weights_3_ce1;
input  [31:0] weights_3_q1;
output  [6:0] bias_3_address0;
output   bias_3_ce0;
input  [31:0] bias_3_q0;
output  [6:0] buffer_3_address0;
output   buffer_3_ce0;
output   buffer_3_we0;
...
reg   [0:0] icmp_ln165_reg_191;
reg    ap_condition_exit_pp0_iter0_stage63;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [7:0] i_16_reg_185;
...
reg   [7:0] i_16_reg_185_pp0_iter1_reg;
reg   [7:0] i_16_reg_185_pp0_iter2_reg;
reg   [7:0] i_16_reg_185_pp0_iter3_reg;
reg   [7:0] i_16_reg_185_pp0_iter4_reg;
reg   [7:0] i_16_reg_185_pp0_iter5_reg;
reg   [7:0] i_16_reg_185_pp0_iter6_reg;
reg   [7:0] i_16_reg_185_pp0_iter7_reg;
reg   [7:0] i_16_reg_185_pp0_iter8_reg;
reg   [7:0] i_16_reg_185_pp0_iter9_reg;
wire   [0:0] icmp_ln165_fu_104_p2;
reg   [0:0] icmp_ln165_reg_191_pp0_iter1_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter2_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter3_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter4_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter5_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter6_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter7_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter8_reg;
reg   [0:0] icmp_ln165_reg_191_pp0_iter9_reg;
wire   [63:0] zext_ln165_fu_125_p1;
reg   [63:0] zext_ln165_reg_195;
reg   [31:0] bias_3_load_reg_205;
...
wire   [31:0] grp_calculate_1_2_fu_78_ap_return;
...
wire    grp_calculate_1_2_fu_78_ap_start;
wire    grp_calculate_1_2_fu_78_ap_done;
wire    grp_calculate_1_2_fu_78_ap_idle;
wire    grp_calculate_1_2_fu_78_ap_ready;
wire   [6:0] grp_calculate_1_2_fu_78_a_address0;
wire    grp_calculate_1_2_fu_78_a_ce0;
wire   [6:0] grp_calculate_1_2_fu_78_a_address1;
wire    grp_calculate_1_2_fu_78_a_ce1;
wire   [13:0] grp_calculate_1_2_fu_78_b_address0;
wire    grp_calculate_1_2_fu_78_b_ce0;
wire   [13:0] grp_calculate_1_2_fu_78_b_address1;
wire    grp_calculate_1_2_fu_78_b_ce1;
wire   [6:0] grp_calculate_1_2_fu_78_b_offset;
reg    grp_calculate_1_2_fu_78_ap_start_reg;
...
#0 grp_calculate_1_2_fu_78_ap_start_reg = 1'b0;
#0 ap_done_reg = 1'b0;
end

mlp_dance3_calculate_1_2 grp_calculate_1_2_fu_78(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_calculate_1_2_fu_78_ap_start_reg <= 1'b0;
    end else begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln165_fu_104_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
            grp_calculate_1_2_fu_78_ap_start_reg <= 1'b1;
        end else if ((grp_calculate_1_2_fu_78_ap_ready == 1'b1)) begin
            grp_calculate_1_2_fu_78_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln165_fu_104_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        zext_ln165_reg_195[7 : 0] <= zext_ln165_fu_125_p1[7 : 0];
    end
end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage63) & (icmp_ln165_reg_191 == 1'd1) & (1'b0 == ap_block_pp0_stage63_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln165_reg_191_pp0_iter9_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage12) & (1'b0 == ap_block_pp0_stage12_subdone) & (ap_enable_reg_pp0_iter9 == 1'b1))) begin
...
assign add_ln165_fu_110_p2 = (ap_sig_allocacmp_i_16 + 8'd1);
...
assign bias_3_address0 = zext_ln165_fu_125_p1;

assign bitcast_ln32_fu_129_p1 = a_assign_6_reg_215;

assign buffer_2_address0 = grp_calculate_1_2_fu_78_a_address0;

assign buffer_2_address1 = grp_calculate_1_2_fu_78_a_address1;

assign buffer_2_ce0 = grp_calculate_1_2_fu_78_a_ce0;

assign buffer_2_ce1 = grp_calculate_1_2_fu_78_a_ce1;

assign buffer_3_address0 = zext_ln165_reg_195;

assign buffer_3_d0 = ((and_ln32_fu_164_p2[0:0] == 1'b1) ? a_assign_6_reg_215 : 32'd0);

assign grp_calculate_1_2_fu_78_ap_start = grp_calculate_1_2_fu_78_ap_start_reg;

assign grp_calculate_1_2_fu_78_b_offset = i_16_reg_185[6:0];

assign grp_fu_479_p_ce = 1'b1;

assign grp_fu_479_p_din0 = a_assign_6_reg_215;
...
assign grp_fu_705_p_din1 = bias_3_load_reg_205;

assign grp_fu_705_p_opcode = 2'd0;

assign icmp_ln165_fu_104_p2 = ((ap_sig_allocacmp_i_16 == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln32_1_fu_152_p2 = ((trunc_ln32_fu_142_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln32_fu_146_p2 = ((tmp_s_fu_132_p4 != 8'd255) ? 1'b1 : 1'b0);

assign or_ln32_fu_158_p2 = (icmp_ln32_fu_146_p2 | icmp_ln32_1_fu_152_p2);

assign tmp_s_fu_132_p4 = {{bitcast_ln32_fu_129_p1[30:23]}};

assign trunc_ln32_fu_142_p1 = bitcast_ln32_fu_129_p1[22:0];

assign weights_3_address0 = grp_calculate_1_2_fu_78_b_address0;

assign weights_3_address1 = grp_calculate_1_2_fu_78_b_address1;

assign weights_3_ce0 = grp_calculate_1_2_fu_78_b_ce0;

assign weights_3_ce1 = grp_calculate_1_2_fu_78_b_ce1;

assign zext_ln165_fu_125_p1 = i_16_reg_185_pp0_iter9_reg;

always @ (posedge ap_clk) begin
    zext_ln165_reg_195[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
end

endmodule //mlp_dance3_mlp_dance3_Pipeline_layer3
