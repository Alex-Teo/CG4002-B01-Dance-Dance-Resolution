...
module mlp_dance3_mlp_dance3_Pipeline_layer2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [13:0] weights_2_address0;
output   weights_2_ce0;
input  [31:0] weights_2_q0;
output  [13:0] weights_2_address1;
output   weights_2_ce1;
input  [31:0] weights_2_q1;
output  [6:0] bias_2_address0;
output   bias_2_ce0;
...
reg   [0:0] icmp_ln160_reg_191_pp0_iter1_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter2_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter3_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter4_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter5_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter6_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter7_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter8_reg;
reg   [0:0] icmp_ln160_reg_191_pp0_iter9_reg;
wire   [63:0] zext_ln160_fu_125_p1;
reg   [63:0] zext_ln160_reg_195;
reg   [31:0] bias_2_load_reg_205;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln160_fu_104_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln160_fu_104_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        zext_ln160_reg_195[7 : 0] <= zext_ln160_fu_125_p1[7 : 0];
    end
end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage63) & (icmp_ln160_reg_191 == 1'd1) & (1'b0 == ap_block_pp0_stage63_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln160_reg_191_pp0_iter9_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage12) & (1'b0 == ap_block_pp0_stage12_subdone) & (ap_enable_reg_pp0_iter9 == 1'b1))) begin
...
assign add_ln160_fu_110_p2 = (ap_sig_allocacmp_i + 8'd1);
...
assign bias_2_address0 = zext_ln160_fu_125_p1;

assign bitcast_ln32_fu_129_p1 = a_assign_4_reg_215;

assign buffer_1_address0 = grp_calculate_1_2_fu_78_a_address0;

assign buffer_1_address1 = grp_calculate_1_2_fu_78_a_address1;

assign buffer_1_ce0 = grp_calculate_1_2_fu_78_a_ce0;

assign buffer_1_ce1 = grp_calculate_1_2_fu_78_a_ce1;

assign buffer_2_address0 = zext_ln160_reg_195;

assign buffer_2_d0 = ((and_ln32_fu_164_p2[0:0] == 1'b1) ? a_assign_4_reg_215 : 32'd0);
...
assign grp_fu_479_p_din0 = a_assign_4_reg_215;
...
assign grp_fu_705_p_din1 = bias_2_load_reg_205;

assign grp_fu_705_p_opcode = 2'd0;

assign icmp_ln160_fu_104_p2 = ((ap_sig_allocacmp_i == 8'd128) ? 1'b1 : 1'b0);
...
assign or_ln32_fu_158_p2 = (icmp_ln32_fu_146_p2 | icmp_ln32_3_fu_152_p2);

assign tmp_s_fu_132_p4 = {{bitcast_ln32_fu_129_p1[30:23]}};

assign trunc_ln32_fu_142_p1 = bitcast_ln32_fu_129_p1[22:0];

assign weights_2_address0 = grp_calculate_1_2_fu_78_b_address0;

assign weights_2_address1 = grp_calculate_1_2_fu_78_b_address1;

assign weights_2_ce0 = grp_calculate_1_2_fu_78_b_ce0;

assign weights_2_ce1 = grp_calculate_1_2_fu_78_b_ce1;

assign zext_ln160_fu_125_p1 = i_reg_185_pp0_iter9_reg;

always @ (posedge ap_clk) begin
    zext_ln160_reg_195[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
end

endmodule //mlp_dance3_mlp_dance3_Pipeline_layer2
