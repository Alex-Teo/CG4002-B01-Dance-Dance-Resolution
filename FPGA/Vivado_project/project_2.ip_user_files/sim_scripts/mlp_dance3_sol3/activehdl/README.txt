...
#
# Generated by export_simulation on Tue Oct 12 05:44:20 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './mlp_dance3_sol3.sh' script.

./mlp_dance3_sol3.sh -reset_run
...
./mlp_dance3_sol3.sh -noclean_files

For more information on the script, please type './mlp_dance3_sol3.sh -help'.
